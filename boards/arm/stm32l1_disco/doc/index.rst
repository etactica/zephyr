...
ST STM32LDISCOVERY and 32L152CDISCOVERY kits
####################
...
an integrated the ST-LINK/V2 debugger and programmer.  The boards have a
segment LCD and a touch slider, along with two user LEDs and a user button.
...
- `STM32LDISCOVERY`_ targets STM32L152RBT6, with 128K flash, 16k ram
- `32L152CDISCOVERY`_ targets STM32L152RCT6, with 256K flash, 32K ram
...
+-----------+------------+-------------------------------------+
| WATCHDOG  | on-chip    | independent watchdog                | FIXME - karl check
+-----------+------------+-------------------------------------+
...
Default Zephyr Peripheral Mapping: KARL FIXME - add i2c and spi and uart3 here
----------------------------------
